...
│──firedetectioncnn.ipynb/ # CNN Model training & evaluation
   ...
   │── **models** # Saved ML models [(link to RandomForest Model Using Sensors][(https://www.kaggle.com/code/basantsaad/fire-detection-by-co2-and-temperature-sensors))](https://www.kaggle.com/code/basantsaad/fire-detection-by-co2-and-temperature)
   , [(link to CNN Fire Detection Model](https://www.kaggle.com/code/basantsaad/fire-detection-cnn-model))
